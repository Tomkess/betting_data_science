...
```{sql Drop Upcoming Matches, connection = con, connection = con, warning = F, message = F, error = T}
drop view if exists v_upcoming_matches;
```

```{sql Upcoming Matches, connection = con, connection = con, warning = F, message = F, error = T}
