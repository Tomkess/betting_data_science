...
select distinct tipsport_league, results_league, results_team, 
string_agg(tipsport_team, '') as tipsport_team from
(select distinct created_at, tipsport_league, results_league, results_team, 
tipsport_team, last_update
from 
(select created_at, 
...
max(created_at) 
over(partition by tipsport_league, results_league, 
results_team, tipsport_team) as last_update 
