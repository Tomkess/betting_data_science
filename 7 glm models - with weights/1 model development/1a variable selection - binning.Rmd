...
subtitle: Variable Selection using "`woeBinning`". Metrics weighted by bookmakers odds.
---
...
folder_path <- "7 glm models - with weights/1 model development/preliminary_data"
