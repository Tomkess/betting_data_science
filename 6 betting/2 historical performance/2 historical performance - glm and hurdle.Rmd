...
hist_path <- "6 betting/2 historical performance"
...
eval_masterdata <- eval_dataset %>%
  ...
  mutate(kelly_c = 
           coalesce(ifelse(pred_res == "Over 2.5", 
                           (pred_prob * odds_251 - 1)/odds_251, 
                           (pred_prob * odds_25 - 1)/odds_25), 0)) %>%
...
save.image("C:/Users/Peter/Desktop/ds_projects/betting_data_science/6 betting/1 model development/preliminary_data/glm_models.RData")
```