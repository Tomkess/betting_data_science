...
load("C:/Users/Peter/Desktop/ds_projects/betting_data_science/6 betting/1 model development/preliminary_data/glm_models.RData")
...
temp_df <- output_ls %>% 
  bind_rows() %>% 
  cbind(., bet_data %>% select(-data, -t_b_goals, -t_interval)) %>%
